...
###GDP distribution for different continents in 2007
...
###Top 5 countries with largest GDP per capita in 2007
```{r}
top_n(arrange(gapminder2007, -gdpPercap), 5)

```

###life expectation over year by continent
```{r}
...
###Life expectancy of different continet
