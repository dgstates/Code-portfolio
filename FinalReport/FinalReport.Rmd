...
ggplot(gapminder_unfiltered, 
  ...
  theme_classic()
#Figure-5
```dLife expectancy is a very important measure when we compare the health of different countries.
...
Life expectancy is a very important measure when we compare the health of different countries.Figure-2 shows there are a strong corrlation between life expectancy and level of income(gdp)
