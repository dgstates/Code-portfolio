...
5. What are the top 5 countries with higher life expetancy in 2007

```{r}
top_n(arrange(gapminder2007, -lifeExpcat), 5)
#Table-3
```



6. What is the life expectation over year by continent
...
7. How does life expectancy relate to GDP over time 
